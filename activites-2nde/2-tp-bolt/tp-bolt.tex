...
%\href{https://github.com/formationPythonPC/formation20-21/tree/master/activites-2nde/tp-astrophysicien/simulation1.py}{\underline{\texttt{simulation1.py}}}
 \item Ouvrez alors le fichier \href{https://github.com/formationPythonPC/formation20-21/tree/master/activites-2nde/tp-astrophysicien/simulation1.py}{\underline{\texttt{simulation1.py}}} avec IDLE ou EduPython. Compilez-le (touche \texttt{F5}).
